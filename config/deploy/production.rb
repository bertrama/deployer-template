...
set :deploy_to, '/hydra/myapp-production/app'
set :default_env, { 'HOME' => '/hydra/myapp-production/app/shared'}
set :log_level, :debug
set :keep_releases, 3
...
set :linked_dirs,  %w{log tmp/pids tmp/cache tmp/sockets tmp/derivatives tmp/uploads vendor/bundle public/system public/uploads}
...
namespace :deploy do
  task :restart do
    on roles(:web) do
      ...
      execute :sudo, '/bin/systemctl', 'restart', 'app-cc-puma@myapp-production.service'
    end
  end
